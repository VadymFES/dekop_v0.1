...
import styles from "./Header.module.css"; // Assuming CSS file is called Header.module.css
      ...
      <nav className={styles.nav}>
        ...
        <div className={styles.activities}>
          ...
          <div className={styles.activityButtons}>
            ...
            <button className={styles.navButton}>Individual order</button>
