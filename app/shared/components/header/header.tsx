        ...
        <div className={`${styles.menuContainer} ${menuOpen ? styles.menuOpen : ''} ${isCatalogView ? styles.noShadow : ''}`}>
          ...
          <div className={styles.activityButtons}>
            ...
            <>
              ...
              <Link className={styles.navButton} href="/contacts">Контакти</Link>
            </>
          </div>
        ...
        <div className={`${styles.rightIcons} ${menuOpen ? styles.hideIcons : ''}`}>
          ...
          <div className={styles.iconContainer}>
            <Link href={'/favorites'} className={styles.iconButton} aria-label="Favorites">
              <svg width="30" height="28" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              {favoritesCount > 0 && <span className={styles.badge} suppressHydrationWarning>{favoritesCount}</span>}
          ...
          <div className={styles.iconContainer}>
            <Link href={'/cart'} className={styles.iconButton} aria-label="Cart">
              <svg width="30" height="28" viewBox="0 0 19 22" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              {totalQuantity > 0 && <span className={styles.badge} suppressHydrationWarning>{totalQuantity}</span>}
