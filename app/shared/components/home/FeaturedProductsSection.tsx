...
import ProductGridSkeleton from "@/app/shared/components/productGrid/ProductGridSkeleton";
 ...
 * Displays up to 6 featured products in a grid layout with carousel on mobile
 * Includes a special showcase image on desktop
 */
export default function FeaturedProductsSection() {
  ...
  // Fetch products using shared hook
