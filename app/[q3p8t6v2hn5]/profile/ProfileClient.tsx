...
export default function ProfileClient({ profile }: ProfileClientProps) {
  ...
  const fetchSessions = async () => {
    try {
      const response = await fetch(`${adminPath}/api/profile/sessions`);
  ...
  const handleUpdateName = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${adminPath}/api/profile`, {
        method: 'PUT',
        headers,
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${adminPath}/api/profile/password`, {
        method: 'PUT',
        headers,
        body: JSON.stringify({
  ...
  const handleEndSession = async (sessionId: string) => {
    ...
    try {
      ...
      const response = await fetch(`${adminPath}/api/profile/sessions/${sessionId}`, {
        method: 'DELETE',
        headers,
      });
