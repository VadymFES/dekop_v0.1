...
export default function OrdersTable({
  ...
  const handleDeleteSelected = async () => {
    ...
    try {
      ...
      const response = await fetch(`${adminPath}/api/orders/bulk-delete`, {
        method: 'DELETE',
        headers,
          ...
          <tbody>
            {orders.map((order) => (
              ...
              >
                ...
                <td style={tdStyle}>
                  <Link href={`${adminPath}/orders/${order.id}`} style={{ color: '#1976d2', fontWeight: 'bold' }}>
                    #{order.order_number}
                  </Link>
                </td>
                ...
                <td style={tdStyle}>
                  <Link href={`${adminPath}/orders/${order.id}`} style={{ color: '#1976d2' }}>
                    Переглянути
                  </Link>
                </td>
              </tr>
