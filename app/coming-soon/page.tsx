    ...
    <main className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.divider}>
          ...
          <svg className={styles.dividerIcon} width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
